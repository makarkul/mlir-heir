...
namespace mlir {
  namespace heir {
    ...
    // A pattern that matches on AffineForLoop and unrolls it
    struct AffineFullUnrollPattern :
      public OpRewritePattern<AffineForOp> {
        ...
        LogicalResult matchAndRewrite(AffineForOp op,
          ...
          // modification to the IR are supposed to go through `rewriter` arg,
          // but it works for our limied test cases.
